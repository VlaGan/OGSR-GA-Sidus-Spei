...
public:
    ...
    void LaunchShell3D(u32 launch_point_idx, LPCSTR sShellSect = nullptr); // Запустить гильзу из указанного launch_point (с возможностью указать свою секцию гильзы)
