...
struct hud_item_measures
{
    ...
    Fvector m_default_rot_pos[2]{};

    Fvector get_def_pos() { return m_default_rot_pos[0]; }
    Fvector get_def_rot() { return m_default_rot_pos[1]; }
...
struct attachable_hud_item
{
    ...
    void hands_set_pos(Fvector pos);
    void hands_set_rot(Fvector rot);
