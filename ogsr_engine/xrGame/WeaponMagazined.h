...
public:
    ...
    virtual void BayonetKick();
    virtual void UpdateBayonetKick();
...
protected:
    ...
    ALife::EHitType cur_bayonet_hittype;
    bool IsBayonetKick;
    float fWallmarkSize{}, fireDistanceBayonet{}, cur_fHitImpulse{}, cur_fHit{}, BayonetHitTime{}, HitTime{};
