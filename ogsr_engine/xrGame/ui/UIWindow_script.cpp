...
#pragma todo( \
    "KRodin: ивент PDA_CONTACTS_WND_CONTACT_SELECTED нигде не вызывается. Надо доделать по необходимости. Хотя я не очень представляю, для чего он может понадобиться в скриптах.")
                      ...
                      value("INVENTORY_DETACH_BAYONET_ADDON", int(INVENTORY_DETACH_BAYONET_ADDON)), value("INVENTORY_DETACH_RAIL_ADDON", int(INVENTORY_DETACH_RAIL_ADDON)),
                      value("INVENTORY_DETACH_LASER_ADDON", int(INVENTORY_DETACH_LASER_ADDON)), value("INVENTORY_DETACH_TORCH_ADDON", int(INVENTORY_DETACH_TORCH_ADDON)),
                      value("INVENTORY_DETACH_TACTHANDLER_ADDON", int(INVENTORY_DETACH_TACTHANDLER_ADDON)),
                  
                  value("INVENTORY_DETACH_EXOBATTERY_ADDON", int(INVENTORY_DETACH_EXOBATTERY_ADDON))
