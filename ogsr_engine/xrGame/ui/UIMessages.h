...
enum EUIMessages : s16
{
    ...
    //INVENTORY_ATTACH_BAYONET_ADDON,
    // АТТАЧИ!!!
    INVENTORY_DETACH_BAYONET_ADDON,
    INVENTORY_DETACH_RAIL_ADDON,
    INVENTORY_DETACH_LASER_ADDON,
    INVENTORY_DETACH_TORCH_ADDON,
    INVENTORY_DETACH_TACTHANDLER_ADDON,


   // INVENTORY_ATTACH_EXOBATTERY_ADDON,
    INVENTORY_DETACH_EXOBATTERY_ADDON,
