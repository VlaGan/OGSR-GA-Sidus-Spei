...
CSE_ALifeItemWeapon::CSE_ALifeItemWeapon(LPCSTR caSection) : CSE_ALifeItem(caSection)
{
    ...
    m_bayonet_status = (EWeaponAddonStatus)pSettings->r_s32(s_name, "bayonet_status");
    m_rail_status = (EWeaponAddonStatus)pSettings->r_s32(s_name, "rail_status");
    m_laser_status = (EWeaponAddonStatus)pSettings->r_s32(s_name, "laser_status");
    m_torch_status = (EWeaponAddonStatus)pSettings->r_s32(s_name, "torch_status");
    m_tact_handler_status = (EWeaponAddonStatus)pSettings->r_s32(s_name, "tact_handler_status");
