...
enum EWeaponAddonState : u16
{
    ...
    eWeaponMisfire = 1 << 5,
    eWeaponAddonBayonet = 1 << 6,
    eWeaponAddonRail = 1 << 7,
    eWeaponAddonLaser = 1 << 8,
    eWeaponAddonTorch = 1 << 9,
    eWeaponAddonTactHandler = 1 << 10,
    ...
    // emaxflag = 1<<7,
    // VlaGan - расширил до 16-ти
};

EWeaponAddonStatus m_scope_status;
EWeaponAddonStatus m_silencer_status;
EWeaponAddonStatus m_grenade_launcher_status;
EWeaponAddonStatus m_bayonet_status;
EWeaponAddonStatus m_rail_status;
EWeaponAddonStatus m_laser_status;
EWeaponAddonStatus m_torch_status;
EWeaponAddonStatus m_tact_handler_status;
